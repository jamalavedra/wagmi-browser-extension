export const __OLD_INSTALL_TIME_KEY = 'extension_install_time'
...
export const LEARN_MORE_URL = 'https://alamaslabs.com/pricing'
...
export const SUPPORT_EMAIL = 'support@alamaslabs.com'
